      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li><a href="index_terresa.php">Home</a></li>
            <li><a href="index_terresa.php?page=kategori">Kategori</a></li>
            <li><a href="index_terresa.php?page=buku">Barang/Buku</a></li>
            <li><a href="index_terresa.php?page=customer">Customer</a></li>
            <li><a href="index_terresa.php?page=laporan">Laporan</a></li>
          </ul>
        </div>
        <div class="container-fluid">
        <div class="row">
