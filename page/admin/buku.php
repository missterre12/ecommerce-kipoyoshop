...
<a href="index_terresa.php?page=input_buku" class="btn btn-success" style="margin-top:20px;"><span class="glyphicon glyphicon-plus"> TAMBAH BUKU</span></a>
<?php
@$aksi = $_GET['aksi'];
if($aksi=="input")
{
...
<table class="table table-bordered" style="margin-top:20px;">
	...
	<tr>
	 ...
	 <td><a href="index_terresa.php?page=editbuku&id=<?php echo $data['id_buku']; ?>"><center>| <span class="glyphicon glyphicon-pencil"></span></a> | | <a href="hapus_book.php?id=<?php echo $data['id_buku']; ?>"><span class="glyphicon glyphicon-trash"></span> |</center></a></td>
	</tr>
	<?php } ?>
</table>
</div>