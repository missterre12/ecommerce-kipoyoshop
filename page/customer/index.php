    ...
    <nav class="navbar navbar-default navbar-fixed-top" style="background:#d74b35;">
      <div class="container-fluid">
        ...
        <div class="nav navbar-nav navbar-right">
         <ul id="nav">
          <li ><a href="index_terresa.php" style="color:#fff;"><span class="glyphicon glyphicon-home"> Home | </span></a></li>
          <li class="a"><a href="detail_terresa.php?page=keranjang" style="color:#fff;"><span class="glyphicon glyphicon-shopping-cart"> Keranjang[<?php
...
<ul>
<li><?php include("../../kat_terresa.php");?></li>
          ...
          if($cek>=1)
          {?>
          <li><a href="index_terresa.php?pesan=sudah konfirmasi"><span class="glyphicon glyphicon-check" style="color:#fff;"> Konfirmasi | </span></a></li><?php
          }else{
          ?>
          <li><a href="carapesan_terresa.php?page=konfirmasi"><span class="glyphicon glyphicon-check" style="color:#fff;"> Konfirmasi | </span></a></li>
          <?php } }?>
...
<ul>
<li><a href="../../logoutcustomer_terresa.php"><span class="glyphicon glyphicon-log-out">Keluar</span></a></li>
</ul>
          </li>
    ...
    <div class="jumbotron">
     ...
     <img src="../../img/buku31.jpg" width="400">   
      ...
      <div class="col-md-6" style="margin-left:70px; margin-top: 80px;">
        <h2><b>Selamat datang di toko murah kami.<h1 style="color:#f97b61;">Toko<b>Saya.Com</b></h1></h2>
        <p>di sini anda bisa membeli dan memesan barang dengan mudah, anda tinggal klik, maka buku sampai di tempat anda, tidak perlu lagi jauh-jauh ke toko kami.</p>
      </div>
    </div>
    </div>
     ...
     include"../../conn_terresa.php";
      ...
      ?>
        ...
        <div class="buku">
          ...
          <center><a class="btn btn-danger" href="detail_terresa.php?id=<?php echo $buku['id_buku'] ?>" role="button" style="margin-top:10px;">View details &raquo;</a></center>
         </div>
        </div>
        <?php } }
        ...
        <h3 style="text-align:center; color:#f97b61; "><?php echo $buku1['judul'] ?></h3>
          ...
          <center><a class="btn btn-danger" href="detail_terresa.php?id=<?php echo $buku1['id_buku'] ?>" role="button" style="margin-top:10px;">View details &raquo;</a></center>
         </div>
        </div>
          <?php }} ?>
      </div>
