  ...
  <div class="jumbotron">
    <div class="row">
      ...
      <div class="col-md-6" style="margin-left:70px; margin-top: 80px;">
        <h2><b>Selamat datang di toko kami.<h1 style="color:#7ED7C1;">Kipoyo<b>Shop</b></h1>
        </h2>
        <p>Di sini anda bisa membeli dan memesan barang dengan mudah, anda tinggal klik, maka produk sampai di tempat anda, tidak perlu lagi jauh-jauh ke toko kami.</p>
      </div>
    </div>
  </div>
