...
Cara Pesan
      ...
      <div class="row" style="margin:20px;">
		<p><h3><b>1. Pembayaran dilakukan dalam jangka waktu 1x24 jam setelah melakukan pemesanan.<br>
          ...
          <br>
		<p style="color:#0000ff;"> BCA KELAPA GADING, JAKUT, No. Rek: 227.007.001.1 Atas Nama: ANIS ROHMADI.
		</p>
		<br>
      ...
      <div style="margin:50px;height:120px;">
        ...
        <ul>
         ...
         <div class="row">
          ...
          <div class="col-md-4">
          <a href="https://twitter.com/anis_rohmadi"><img src="images/Twitter.png" style="width:70px;height:75px;"></a>
          </div>
         </div>
        </ul>
        </center>
