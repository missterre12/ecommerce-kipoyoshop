  ...
  <nav class="navbar navbar-default navbar-fixed-top" style="background:#37B5B6;">
    <div class="container-fluid">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#"><img src="images/logo-header.png" style="width:150px; margin-top: -7px;"></img>
      </div>
  ...
  <div class="jumbotron">
    <div class="row">
      ...
      <div class="col-md-6" style="margin-left:70px; margin-top: 80px;">
        ...
        <p>Di sini Anda bisa membeli dan memesan barang-barang dengan mudah, Anda tinggal klik, maka barang yang Anda beli sampai di tempat rumah Anda, tidak perlu lagi jauh jauh ke toko.</p>
      </div>
    </div>
  </div>
  <div style="margin-top:-30px;width:100%; height:50px;text-align:center;background: #37B5B6;color:#fff;line-height:60px;font-size:20px;margin-bottom:20px;">
    Cara Pesan
  </div>
  <div class="jumbotron" style="margin-top:-30px;">
    <div class="row" style="margin:20px;">
      ...
      <h3><b>1. Pembayaran dilakukan dalam jangka waktu 1x24 jam setelah melakukan pemesanan.<br>
        ...
        <p style="color:red;">*Harga barang belum termasuk ongkos kirim, dan ongkos kirim akan disesuaikan dengan tujuan pengiriman.</p>
      </h3>
    </div>
  </div>
