...
<html lang="en">
  ...
  <body>
    ...
    <section class="hero-daftar" id="home-daftar">
      <main class="content-daftar">
        <div class="daftar-box">
          ...
          <form action="ceklogin_terresa.php" method="post">
            ...
            <button type="submit" class="cta">Registrasi</button>
          </form>
          <p>Sudah punya akun? <a href="login_terresa.php">Login</a></p>
        </div>
