  ...
  <nav class="navbar navbar-default navbar-fixed-top" style="background:#37B5B6;">
    <div class="container-fluid">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#" style="color:#fff; font-size:30px;">Kipoyo<b>Shop</b></a>
      </div>
  ...
  <div class="jumbotron">
    <div class="row">
      ...
      <div class="col-md-6" style="margin-left:70px;">
        <h2><b>Selamat datang di toko online shop kami.<h1>Kipoyo<b>Shop</b></h1>
        </h2>
        <p>Di sini Anda bisa membeli dan memesan produk dengan mudah, Anda tinggal klik, maka produk sampai di tempat Anda. tidak perlu lagi jauh-jauh ke toko produk.</p>
      </div>
    </div>
  </div>
      ...
      ?>
          ...
          <div class="col-md-4" style="margin-top:20px;">
            <div class="produk">
              ...
              <h3 style="text-align:center; color:#0000ff;"><?php echo $produk['nama_barang'] ?></h3>
        ...
        while ($produk1 = mysqli_fetch_array($qryprodukkat)) { ?>
          <div class="col-md-4" style="margin-top:20px;">
            <div class="produk">
              <center><img src="gambar/<?php echo $produk1['gambar'] ?>" style="margin-top:20px;width:200px;height:190px;"></center>
              <h3 style="text-align:center; color:#0000ff; "><?php echo $produk1['nama_barang'] ?></h3>
